...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="mot_vedette">
	...
	<xsl:template match="catégorie_grammaticale">
	...
	<xsl:template match="exemples">
	  <ul class="examples"><xsl:apply-templates /></ul>
	</xsl:template>

	<xsl:template match="exemple">
	  <xsl:if test="exemple-wol/text()!=''"><li class="example"><xsl:apply-templates /></li></xsl:if>
	</xsl:template>

	<xsl:template match="exemple-wol">
	  <span class="wol"><xsl:apply-templates /></span>
	</xsl:template>

	<xsl:template match="exemple-fra">
	  <span class="fra"><xsl:apply-templates /></span>
	</xsl:template>

	<xsl:template match="synonyme">
	  <xsl:if test="text()!=''"><span class="synonym">Synonyme : <xsl:apply-templates /></span></xsl:if>
	</xsl:template>

	<xsl:template match="homonyme">
	  <xsl:if test="text()!=''"><span class="homonym">Homonyme : <xsl:apply-templates /></span></xsl:if>
	</xsl:template>
